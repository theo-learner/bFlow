...
def main():
  try:
    ...
    removeFile("data/fExtractTime.csv")
    removeFile("data/sExtractTime.csv")
    removeFile("data/cExtractTime.csv")
    removeFile("data/kExtractTime.csv")
    removeFile("data/numCNode.csv")
    removeFile("data/numNode.csv")
    removeFile("data/numEdge.csv")
    removeFile("data/numVE.csv")
    removeFile("data/maxLength.csv")
    removeFile("data/alphaLength.csv")
    ...
    for line in flines:
      ...
      yelapsed = timeit.default_timer() - start_yosys;
      noOpt = False;
      ...
      if hierFlag:
        ...
        if(checkSecondRun == True): 
          if(noOpt == False):
            ...
            start_yosys = timeit.default_timer();
            val  = yosys.create_yosys_script(line, scriptName+"_show", hier=hierFlag, opt=optFlag-1)
